    ...
    <el-table v-loading="loading" :data="subjectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['ums:subject:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['ums:subject:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { listSubject, getSubject, delSubject, addSubject, updateSubject } from "@/api/ums/subject"
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除会员收藏的专题活动编号为"' + _ids + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('ums/subject/export', {
    ...queryParams.value
