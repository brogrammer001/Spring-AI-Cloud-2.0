  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="sessionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['sms:session:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['sms:session:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { listSession, getSession, delSession, addSession, updateSession } from "@/api/sms/session"
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除秒杀活动场次编号为"' + _ids + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('sms/session/export', {
    ...queryParams.value
