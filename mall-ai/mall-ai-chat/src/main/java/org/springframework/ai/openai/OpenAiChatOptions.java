...
public class OpenAiChatOptions implements ToolCallingChatOptions, StructuredOutputChatOptions {
    ...
    private final org.springframework.ai.openai.OpenAiChatModel.@Nullable ResponseFormat responseFormat;
    ...
    protected OpenAiChatOptions(@Nullable String baseUrl, @Nullable String apiKey, @Nullable Credential credential,
                                ...
                                @Nullable AudioParameters outputAudio, org.springframework.ai.openai.OpenAiChatModel.@Nullable ResponseFormat responseFormat,
     ...
     */
    public org.springframework.ai.openai.OpenAiChatModel.@Nullable ResponseFormat getResponseFormat() {
     ...
     * {@link org.springframework.ai.openai.OpenAiChatModel.ResponseFormat.Builder#strict(Boolean)}, which controls
    ...
    public @Nullable String getOutputSchema() {
        org.springframework.ai.openai.OpenAiChatModel.ResponseFormat format = this.getResponseFormat();
    ...
    protected abstract static class AbstractBuilder<B extends AbstractBuilder<B>>
        ...
        protected org.springframework.ai.openai.OpenAiChatModel.@Nullable ResponseFormat responseFormat;
        ...
        public B responseFormat(org.springframework.ai.openai.OpenAiChatModel.@Nullable ResponseFormat responseFormat) {
            this.responseFormat = responseFormat;
            return self();
        }
         ...
         * {@link org.springframework.ai.openai.OpenAiChatModel.ResponseFormat.Builder#strict(Boolean)}, which applies
